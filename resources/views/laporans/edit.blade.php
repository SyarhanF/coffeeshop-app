...
<div class="col-md-7">
    <div class="d-flex align-items-center mb-4">
        ...
        <h2 class="page-title mb-0"><i class="bi bi-bar-chart me-2"></i>Edit Laporan</h2>
    </div>

    <div class="card">
        <div class="card-header py-3">
            <h5 class="mb-0">Edit: <strong>{{ $laporan->judul }}</strong></h5>
        </div>
            ...
            <form action="{{ route('laporans.update', $laporan->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="tanggal_selesai"
                               ...
                               value="{{ old('tanggal_selesai', $laporan->tanggal_selesai) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="total_transaksi" class="form-control"
                               value="{{ old('total_transaksi', $laporan->total_transaksi) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Total Pendapatan (Rp)</label>
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" name="total_pendapatan" class="form-control"
                                   value="{{ old('total_pendapatan', $laporan->total_pendapatan) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="keterangan" rows="3"
                              ...
                              placeholder="Catatan tambahan (opsional)">{{ old('keterangan', $laporan->keterangan) }}</textarea>
